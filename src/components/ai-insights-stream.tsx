      ...
      >
        ...
        >
          {app.icon.startsWith('data:image') || app.icon.startsWith('http') ? (
            <div className="w-full h-full rounded-lg overflow-hidden flex items-center justify-center p-1 bg-black/10">
              <img src={app.icon} alt={app.name} className="max-w-full max-h-full object-contain" />
            </div>
          ) : (
